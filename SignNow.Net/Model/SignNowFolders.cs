...
namespace SignNow.Net.Model
{
    ...
    public class SignNowFolders : BaseFolder
    {
        ...
        public IReadOnlyCollection<Folder> Folders { get; set; } = new List<Folder>();

        /// <summary>
        /// <see cref="SignNowDocument"/> objects stored in this folder and their attributes.
        /// </summary>
        [JsonProperty("documents")]
        public IReadOnlyCollection<SignNowDocument> Documents { get; set; } = new List<SignNowDocument>();
    }
}
